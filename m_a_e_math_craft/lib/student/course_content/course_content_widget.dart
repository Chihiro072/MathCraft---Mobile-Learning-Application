                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: StreamBuilder<CourseRecord>(
                          stream: CourseRecord.getDocument(widget.courseName!),
                          builder: (context, snapshot) {
                            ...
                            final scrollingColumnCourseRecord = snapshot.data!;
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            16.0, 10.0, 0.0, 10.0),
                                        child: Text(
                                          scrollingColumnCourseRecord.name,
                                  ...
                                  Builder(
                                    builder: (context) {
                                      final content =
                                          scrollingColumnCourseRecord.content
                                              .map((e) => e)
                                              .toList();
                                    ...
                                    child: Padding(
                                      ...
                                      child: StreamBuilder<List<CourseRecord>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<CourseRecord>
                                              buttonCourseRecordList =
                                              snapshot.data!;
                                          // Return an empty Container when the item does not exist.
                                          if (snapshot.data!.isEmpty) {
                                            return Container();
                                          }
                                          final buttonCourseRecord =
                                              buttonCourseRecordList.isNotEmpty
                                                  ? buttonCourseRecordList.first
                                                  : null;
                                          ...
                                          return FFButtonWidget(
                                            onPressed: () async {
                                              ...
                                              await AssessmentRecord.collection
                                                  .doc()
                                                  .set(
                                                      createAssessmentRecordData(
                                                    quizName: buttonCourseRecord
                                                        ?.name,
                                                    studentName:
                                                        currentUserEmail,
                                                    score: 0,
