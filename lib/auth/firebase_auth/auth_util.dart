...
DocumentReference? get currentUserReference =>
    loggedIn ? MathCraftRecord.collection.doc(currentUser!.uid) : null;

MathCraftRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : MathCraftRecord.getDocument(MathCraftRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
