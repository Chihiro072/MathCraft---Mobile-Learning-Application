...
class _AuthenticationWidgetState extends State<AuthenticationWidget>
  ...
  void initState() {
    ...
    _model.roleCreateTextController ??= TextEditingController(text: 'Student');
    _model.roleCreateFocusNode ??= FocusNode();
                                                    ...
                                                    child: SizedBox(
                                                      ...
                                                      child: TextFormField(
                                                        ...
                                                        keyboardType:
                                                            TextInputType.name,
                                                        validator: _model
                                                            .roleCreateTextControllerValidator
                                                            .asValidator(
                                                                context),
                                                      ),
                                                    ),
                                                      ...
                                                      builder:
                                                        ...
                                                        return FFButtonWidget(
                                                          onPressed: () async {
                                                            ...
                                                            await MathCraftRecord
                                                                .collection
                                                                .doc(user.uid)
                                                                .update(
                                                                    createMathCraftRecordData(
                                                                  role: Role
                                                                      .Teacher,
                                                                ));
